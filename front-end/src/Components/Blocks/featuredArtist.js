...
class FeaturedArtist extends React.Component {
    ...
    PlayArtist = () => {
        const {ResumePlayer, StopPlayer, playSong, getArtistTopTracks} = this.props.player.player
		if (!this.props.active) {
			...
			getArtistTopTracks(this.props.artistId).then(result => {
				...
				playSong(uris).catch(e => console.debug(e)).then(e => console.debug(e))
			});
        ...
        return (
            <div className="container" style={containerStyle}>
                <div className="block" style={{background: this.state.colors.DarkMuted}}>
                    ...
                    <div className="artist-hover-state" style={hoverState}  onClick={() => this.PlayArtist()} >
